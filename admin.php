				...
				$(document).on('submit', '.new-user-form', function (e) {
					...
					$.ajax({
						...
						success: function () {
							...
							$('#new-user-submission-message-row').load('admin.php #new-user-submission-message-col');
							
							// Loads new ticket form
							$('#new-ticket-form-row').load('admin.php #new-ticket-form-col');
						}
					});
				});
			});
				...
				$(document).on('submit', '.new-ticket-form', function (e) {
					...
					$.ajax({
						...
						success: function () {
							...
							$('#new-ticket-submission-message-row').load('admin.php #new-ticket-submission-message-col');
						}
					});
				});
			});

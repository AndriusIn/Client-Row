...
<html>
	...
	<body>
		...
		<div class="container-fluid py-3">
				...
				<div class="col">
					<form method="get">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="ticket-id" name="ticket-id" placeholder="<?php echo $language['ticket-search-id-placeholder']; ?>">
						</div>
			...
			<div class="row" id="ticket-search-table-row" style="display: none;">
				<div class="col" id="ticket-search-table-col">
				</div>
			</div>
		</div>
	</body>

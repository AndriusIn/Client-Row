...
define("L_ENGLISH", 
	array(
		...
		'ticket-search-id-error' => 'Invalid ticket ID!', 
		'ticket-search-submit-button-title' => 'Search', 
		'ticket-search-table-id-header' => 'Ticket ID', 
		'ticket-search-table-client-header' => 'Client', 
		'ticket-search-table-specialist-header' => 'Specialist', 
		'ticket-search-table-average-duration-header' => 'Waiting duration', 
		'ticket-search-table-average-duration-error' => 'Unknown', 
		...
		'client-board-average-duration-header' => 'Waiting duration', 
		'client-board-average-duration-error' => 'Unknown', 
...
define("L_LITHUANIAN", 
	array(
		...
		'ticket-search-id-error' => 'Netinkamas lapuko ID!', 
		'ticket-search-submit-button-title' => 'Ieškoti', 
		'ticket-search-table-id-header' => 'Lapuko ID', 
		'ticket-search-table-client-header' => 'Klientas', 
		'ticket-search-table-specialist-header' => 'Specialistas', 
		'ticket-search-table-average-duration-header' => 'Laukimo trukmė', 
		'ticket-search-table-average-duration-error' => 'Nežinoma', 
		...
		'client-board-average-duration-header' => 'Laukimo trukmė', 
		'client-board-average-duration-error' => 'Nežinoma', 
